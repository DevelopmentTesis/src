 ...
 * element interface generated in the cl.hotoffer.business.validador package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _Persona_QNAME = new QName(
			"http://cl.hotoffer/hotoffer", "Persona");
	private final static QName _Publicacion_QNAME = new QName(
			"http://cl.hotoffer/hotoffer", "Publicacion");
	private final static QName _Geolocalizacion_QNAME = new QName(
			"http://cl.hotoffer/hotoffer", "Geolocalizacion");
	private final static QName _Usuario_QNAME = new QName(
			"http://cl.hotoffer/hotoffer", "Usuario");
	private final static QName _TipoPublicacion_QNAME = new QName(
			"http://cl.hotoffer/hotoffer", "TipoPublicacion");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: cl.hotoffer.business.validador
	 * 
	 */
	...
	public JAXBElement<Persona> createPersona(Persona value) {
		return new JAXBElement<Persona>(_Persona_QNAME, Persona.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link Publicacion }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<Publicacion> createPublicacion(Publicacion value) {
		return new JAXBElement<Publicacion>(_Publicacion_QNAME,
				Publicacion.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link Geolocalizacion }
	 * {@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://cl.hotoffer/hotoffer", name = "Geolocalizacion")
	public JAXBElement<Geolocalizacion> createGeolocalizacion(
			Geolocalizacion value) {
		return new JAXBElement<Geolocalizacion>(_Geolocalizacion_QNAME,
				Geolocalizacion.class, null, value);
	}
	...
	public JAXBElement<Usuario> createUsuario(Usuario value) {
		return new JAXBElement<Usuario>(_Usuario_QNAME, Usuario.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link TipoPublicacion }
	 * {@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://cl.hotoffer/hotoffer", name = "TipoPublicacion")
	public JAXBElement<TipoPublicacion> createTipoPublicacion(
			TipoPublicacion value) {
		return new JAXBElement<TipoPublicacion>(_TipoPublicacion_QNAME,
				TipoPublicacion.class, null, value);
	}
